        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardImg3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CardLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CardLinkName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParaOne = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParaTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParaThree = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParaFour = table.Column<string>(type: "nvarchar(max)", nullable: true),
